...
class Labyrinth():
    def __init__(self, maze_gen, goal = None):
        self.maze = maze_gen.maze # assumed maze similar style as generated by MazeGenerator class
        self.goal = maze_gen.goal #goal if goal else (len(self.maze[0]) - 0.5, len(self.maze) - 0.5)
        print(self.goal)
        return
